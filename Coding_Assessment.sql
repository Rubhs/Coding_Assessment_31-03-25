...
SELECT AW.Title,A.Name,AW.Year AS ArtistName FROM Artworks AW JOIN Artists A ON AW.ArtistID=A.ArtistID
...
SELECT A.Name,COUNT(C.CategoryID) AS ArtworkCount FROM Artists A 
